...
export default function MenuColomboPage() {
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-8">
          ...
          <div className="relative overflow-hidden rounded-[28px] border border-black/5 shadow-[0_18px_60px_rgba(0,0,0,0.10)]">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://static.readdy.ai/image/950ece443f523582842352d95e566920/ef0b06156bb21a1ba0d85ec94be5bf18.jpeg')",
              }}
              aria-hidden="true"
            />
            {/* Soft blend */}
            ...
            <div className="absolute inset-x-0 top-0 z-10 h-[380px] sm:h-[400px] lg:h-[570px] overflow-hidden">
              {/* Mobile / Tablet */}
              <img
                src="https://static.readdy.ai/image/950ece443f523582842352d95e566920/fd52196eab72ee078fc9bd871d9909c6.png"
                alt="Sky Sanctuary signature treatment"
                className="absolute inset-0 h-full w-full object-cover lg:hidden"
                style={{
                  transform: 'scale(1.06)',
                  objectPosition: '30% 68%',
                }}
              />
              {/* PC */}
              <img
                src="https://static.readdy.ai/image/950ece443f523582842352d95e566920/fd52196eab72ee078fc9bd871d9909c6.png"
                alt="Sky Sanctuary signature treatment"
                className="absolute inset-0 hidden lg:block h-full w-full object-cover"
                style={{
                  transform: 'scale(1.06)',
                  ...
                  >
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        A complete pampering for your feet to wash off the stress and weariness to provide the
                        ultimate relaxation and comfort. Each session continues with a relaxing massage using
                        natural body oil or body lotion, focusing on pressure points to result in instant stress
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          <div className="menu-option">
                            ...
                            <span className="menu-price">LKR 12,800</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        A stress relieving and calming massage which begins at the head and continues to the
                        neck and shoulders, up to the hands, focusing on pressure points to remove and reduce
                        stress and result in better physical and mental relaxation.
                      </p>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        A therapeutic head massage treatment focusing on total hair and scalp health,
                        promoting hair growth and a complete relaxation.
                      </p>
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          <div className="menu-option">
                            <span className="menu-time">45 min</span>
                            <span className="menu-price">LKR 15,300</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        An ultra relaxing body massage starting from the head and proceeding to the neck,
                        shoulders, up to the feet, targeting all the pressure points along the way up to the
                        lower back to relax and remove stress on both upper and lower body.
                      </p>
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          <div className="menu-option">
                            ...
                            <span className="menu-price">LKR 17,600</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        The self‑healing powers of pure aroma oils, combined with soothing massage strokes of
                        therapists for a total relaxation that your body craves.
                      </p>
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          ...
                          <div className="menu-option">
                            ...
                            <span className="menu-price">LKR 15,200</span>
                          </div>
                          {/* 90 min option with note */}
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        Helps release knots and strains in the deeper layers of muscle and connective tissue.
                        The treatment will leave you with a revitalized feeling of wellbeing.
                      </p>
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          ...
                          <div className="menu-option">
                            <span className="menu-time">60 min</span>
                            <span className="menu-price">LKR 15,700</span>
                          </div>
                          {/* 90 min with note (fixed extra parenthesis) */}
                          <div className="menu-option menu-option-divider">
                            <span className="menu-time">
                              90 min
                              <span className="block mt-0.5 text-[11px] sm:text-xs text-[#6B4F3A]/80 leading-tight whitespace-nowrap">
                            ...
                            <span className="menu-price">LKR 19,800</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        Hot herbal compress focusing on the lower back area, proceeding on to a complete 360
                        massage from head to toe starting from the upper back to legs, focusing on the
                        pressure points on the lower back up to the legs and the feet. As the next step, the
                        massage will continue from head to toe and back to head, ending with a relaxing head
                        massage.
                      </p>
                      ...
                      <div className="menu-meta">
                        <div className="menu-options">
                          <div className="menu-option">
                            <span className="menu-time">90 min</span>
                            <span className="menu-price">LKR 24,200</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="menu-card">
                      ...
                      <p className="menu-desc">
                        Carefully removing dead skin cells and drawing out impurities from your skin, for a
                        glowing and soothing skin.
                      </p>
                      ...
                      <div className="menu-meta">
                        ...
                        <div className="menu-options">
                          <div className="menu-option">
                            ...
                            <span className="menu-price">LKR 3,800</span>
                          </div>
                        </div>
                      </div>
                    </div>
